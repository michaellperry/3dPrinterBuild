...
#define STRING_CONFIG_H_AUTHOR "(Jamman, TEVO Tarantula config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AHS Animation"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //#define  DEFAULT_bedKd 1675.16
	...
	#define  DEFAULT_bedKp 241.91
	#define  DEFAULT_bedKi  47.32
	#define  DEFAULT_bedKd 309.16
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80.8,1585,97}
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 80}    // (mm/sec)
